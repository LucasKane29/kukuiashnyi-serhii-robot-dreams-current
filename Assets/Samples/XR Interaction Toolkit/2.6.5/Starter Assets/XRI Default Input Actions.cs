...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""XRI LeftHand Gameplay"",
            ""id"": ""2e0cb371-36bc-4fae-8f77-b4a91e920d99"",
            ""actions"": [
                {
                    ""name"": ""MenuButton"",
                    ""type"": ""Button"",
                    ""id"": ""0839792d-732b-42b2-af79-0aba23185e31"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ...
                    ""type"": ""Button"",
                    ""id"": ""34c3f3f8-b590-46f3-bdd2-80dc73b7a84d"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""PrimaryButton"",
                    ""type"": ""Button"",
                    ""id"": ""8298f86c-a239-42f6-be14-031a7a453d86"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""687c8de9-5940-4fec-9a14-97345498327a"",
                ...
                {
                    ""name"": """",
                    ""id"": ""36aaf0eb-23df-43ac-9fc5-491702584a8d"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""5c393765-fff2-4c37-9d48-5ceaf50be4b9"",
                ...
                {
                    ""name"": """",
                    ""id"": ""ea48b43b-ed36-4b89-9fe8-091c6754f1e0"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""cb054ef8-33b0-4a8e-ab47-ea4df7789351"",
                ...
                {
                    ""name"": """",
                    ""id"": ""361e67db-a6ad-48e9-82b4-9551d726a2e8"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        // XRI LeftHand Gameplay
        m_XRILeftHandGameplay = asset.FindActionMap("XRI LeftHand Gameplay", throwIfNotFound: true);
        m_XRILeftHandGameplay_MenuButton = m_XRILeftHandGameplay.FindAction("MenuButton", throwIfNotFound: true);
        m_XRILeftHandGameplay_SecondaryButton = m_XRILeftHandGameplay.FindAction("SecondaryButton", throwIfNotFound: true);
        m_XRILeftHandGameplay_PrimaryButton = m_XRILeftHandGameplay.FindAction("PrimaryButton", throwIfNotFound: true);
    }
    ...
    ~@XRIDefaultInputActions()
    {
        ...
        UnityEngine.Debug.Assert(!m_XRILeftHandGameplay.enabled, "This will cause a leak and performance issues, XRIDefaultInputActions.XRILeftHandGameplay.Disable() has not been called.");
    }
    ...
    // XRI LeftHand Gameplay
    private readonly InputActionMap m_XRILeftHandGameplay;
    private List<IXRILeftHandGameplayActions> m_XRILeftHandGameplayActionsCallbackInterfaces = new List<IXRILeftHandGameplayActions>();
    private readonly InputAction m_XRILeftHandGameplay_MenuButton;
    private readonly InputAction m_XRILeftHandGameplay_SecondaryButton;
    private readonly InputAction m_XRILeftHandGameplay_PrimaryButton;
    /// <summary>
    /// Provides access to input actions defined in input action map "XRI LeftHand Gameplay".
    /// </summary>
    public struct XRILeftHandGameplayActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public XRILeftHandGameplayActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "XRILeftHandGameplay/MenuButton".
        /// </summary>
        public InputAction @MenuButton => m_Wrapper.m_XRILeftHandGameplay_MenuButton;
        /// <summary>
        /// Provides access to the underlying input action "XRILeftHandGameplay/SecondaryButton".
        /// </summary>
        public InputAction @SecondaryButton => m_Wrapper.m_XRILeftHandGameplay_SecondaryButton;
        /// <summary>
        /// Provides access to the underlying input action "XRILeftHandGameplay/PrimaryButton".
        /// </summary>
        public InputAction @PrimaryButton => m_Wrapper.m_XRILeftHandGameplay_PrimaryButton;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_XRILeftHandGameplay; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="XRILeftHandGameplayActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(XRILeftHandGameplayActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="XRILeftHandGameplayActions" />
        public void AddCallbacks(IXRILeftHandGameplayActions instance)
        {
            if (instance == null || m_Wrapper.m_XRILeftHandGameplayActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_XRILeftHandGameplayActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="XRILeftHandGameplayActions" />
        private void UnregisterCallbacks(IXRILeftHandGameplayActions instance)
        {
            @MenuButton.started -= instance.OnMenuButton;
            @MenuButton.performed -= instance.OnMenuButton;
            @MenuButton.canceled -= instance.OnMenuButton;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="XRILeftHandGameplayActions.UnregisterCallbacks(IXRILeftHandGameplayActions)" />.
        /// </summary>
        /// <seealso cref="XRILeftHandGameplayActions.UnregisterCallbacks(IXRILeftHandGameplayActions)" />
        public void RemoveCallbacks(IXRILeftHandGameplayActions instance)
        {
            if (m_Wrapper.m_XRILeftHandGameplayActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="XRILeftHandGameplayActions.AddCallbacks(IXRILeftHandGameplayActions)" />
        /// <seealso cref="XRILeftHandGameplayActions.RemoveCallbacks(IXRILeftHandGameplayActions)" />
        /// <seealso cref="XRILeftHandGameplayActions.UnregisterCallbacks(IXRILeftHandGameplayActions)" />
        public void SetCallbacks(IXRILeftHandGameplayActions instance)
        {
            foreach (var item in m_Wrapper.m_XRILeftHandGameplayActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_XRILeftHandGameplayActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="XRILeftHandGameplayActions" /> instance referencing this action map.
    /// </summary>
    public XRILeftHandGameplayActions @XRILeftHandGameplay => new XRILeftHandGameplayActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "XRI LeftHand Gameplay" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="XRILeftHandGameplayActions.AddCallbacks(IXRILeftHandGameplayActions)" />
    /// <seealso cref="XRILeftHandGameplayActions.RemoveCallbacks(IXRILeftHandGameplayActions)" />
    public interface IXRILeftHandGameplayActions
    {
        /// <summary>
